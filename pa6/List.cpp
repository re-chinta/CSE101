...
ListElement List::front() const{
    if (length()>0) {
            ...
            throw std::length_error("front error");
        }
}
...
ListElement List::back() const{
    if (length()>0) {
            ...
            throw std::length_error("back error");
        }
...
ListElement List::peekNext() const{
    if (position() < length()) {
            ...
            throw std::range_error("peekNext error position not less than length");
        }
}
...
ListElement List::peekPrev() const{
    if (position() > 0) {
            ...
            throw std::range_error("peekPrev error");
        }
}
...
ListElement List::movePrev(){
    ...
    if (position() > 0) {
        ...
        throw std::range_error("movePrev error");
    }
...
void List::setAfter(ListElement x){
    if (position()<length()) {
            ...
            throw std::range_error("setAfter error");
        }
...
void List::setBefore(ListElement x){
    if (position() > 0) {
            ...
            throw std::range_error("setBefore error");
        }
...
void List::eraseAfter(){
  ...
  if (position()<length()) {
    ...
    num_elements --;
            ...
            throw std::range_error("eraseAfter error");
        }
...
void List::eraseBefore(){
    ...
    num_elements --;
            ...
            throw std::range_error("eraseBefore error");
        }
